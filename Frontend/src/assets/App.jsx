...
import './App.css'; // Kita akan membuat file ini selanjutnya

// --- ASET GAMBAR ---
// Impor gambar-gambar Anda di sini.
// Pastikan path filenya benar (misalnya, '/src/assets/nama-file.png')
import logoPeduli from './assets/logo-peduli.png'; // Ganti dengan path logo PeduliFTUI Anda
import logoPengmas from './assets/logo-pengmas.png'; // Ganti dengan path logo PENGMAS IME FTUI
import logoPay from './assets/logo-pay.png'; // Ganti dengan path logo Pay
    ...
    <div className="page-container">
      ...
      <header className="navbar">
        <div className="nav-logo">
          <img src={logoPeduli} alt="PeduliFTUI Logo" />
        </div>
